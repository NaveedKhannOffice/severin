            ...
            <Container fluid>
                <Row>
                    <Col sm={12} className="gap-3 d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-3 mb-lg-4">
                        ...
                        <button className="btn btn-primary" onClick={handleAcountDelete}>Delete Account</button>
                    </Col>
                </Row>
                <Row>
                                    ...
                                    <>
                                        <Row>
                                            ...
                                            <Col xs={12} lg={4} className="mb-3 mb-lg-4 mb-xxl-5">
                                                ...
                                                <p className="text-black text-capitalize fw-semibold"><span className="me-1">{getCountryFlag((!(user?.dialing_code) ? user?.phone : (user?.dialing_code+user?.phone))) ?? 'N/a'}</span>
                                                    {user?.phone}</p>
                                            </Col>
                                        </Row>
                                        <Row className="d-flex justify-content-center">
                                            <Col xs={12} lg={4} className="mb-3 mb-lg-4 mb-xxl-5">
                                                ...
                                                <p className="text-black text-capitalize fw-semibold">{user?.language ?? 'N/a'}</p>
                                            </Col>
                                            <Col xs={12} lg={4} className="mb-3 mb-lg-4 mb-xxl-5">
                                                <h5 className="mb-0 fw-medium text-capitalize mb-2">Your Relationship</h5>
                                                <p className="text-black text-capitalize fw-semibold">{user?.relation ?? 'N/a'}</p>
                                            </Col>
                                        </Row>
                                        <Row>
