...
const OrderLogsDetail = ({ showModal }) => {
  ...
  const updateReview = async (status, id) => {
    showModal(`successful`, `Review has been submitted`, null, true);
  };
          ...
          <Row>
            <Col sm={12} className="d-flex align-items-center mb-4 mb-xxl-5">
              <div className="flex-grow-1 d-flex align-items-center">
                ...
                <h2 className="page-title fw-bold mb-0">Order Details</h2>
              </div>
              <div className="flex-shrink-0">
                <div
                  className={`status-rounded text-capitalize ${
                    data?.order?.status?.toLowerCase() == "delivered"
                      ? "bg-green"
                      : data?.order?.status?.toLowerCase() == "cancelled"
                      ? "bg-red"
            ...
            <Col lg={8}>
              <Row>
                <Col
                  ...
                  lg={3}
                  xxl={3}
                  className="mb-2 mb-md-3 mb-lg-3 mb-xxl-4 detail-card"
                >
                ...
                >
                  ...
                  <p className="fw-normal">
                    {dateFormat(data?.order?.created_at)}
                  </p>
                </Col>
                <Col
                  xs={12}
                    ...
                    <thead>
                      <tr>
                        ...
                        <th className="product-thumbnail">
                          <span className="d-none">Thumbnail image</span>
                        </th>
                      ...
                      {data?.order?.details?.map((item, index) => (
                        <tr className="cart-item">
                          ...
                          <td
                            ...
                            cart-data-title="Product"
                          >
                            <a className="cart-title">{item?.product?.title}</a>
                            <div className="cart-meta-category">
                              {item?.product?.category?.category_title}
                            </div>
                          </td>
                          <td className="product-price" cart-data-title="Price">
                            <div className="cart-price">
                              {item?.product?.delivery_option}
                            </div>
                          </td>
                          <td className="product-price" cart-data-title="Price">
                          ...
                          {data?.order?.status?.toLowerCase() ==
                            ...
                            <td className="product-rating">
                              <Link
                                onClick={() => {
                                  handleRatingModal(item?.product?.id);
                                }}
                              >
                                Rate Product
                              </Link>
                ...
                <>
                  <Row className="mt-3">
                    ...
                    >
                      ...
                      <p className="fw-normal">
                        {data?.order?.addresses?.[0]?.first_name +
                          " " +
                          data?.order?.addresses?.[0]?.last_name}
                      </p>
                    </Col>
                    <Col
                      xs={12}
                ...
                <>
                  <Row className="mt-3">
                    ...
                    >
                      <h5 className="mb-2 fw-semibold">User Name</h5>
                      <p className="fw-normal">
                        {data?.order?.addresses?.[1]?.first_name +
                          " " +
                          data?.order?.addresses?.[1]?.last_name}
                      </p>
                    </Col>
                    <Col
                      xs={12}
                    ...
                    >
                      ...
                      <p className="fw-normal">
                        {data?.order?.addresses?.[1]?.address}
                      </p>
                    </Col>
                    <Col
                      xs={12}
                    ...
                    >
                      ...
                      <p className="fw-normal">
                        {data?.order?.addresses?.[1]?.country}
                      </p>
                    </Col>
                    <Col
                      xs={12}
                    ...
                    >
                      ...
                      <p className="fw-normal">
                        {data?.order?.addresses?.[1]?.zip_code}
                      </p>
                    </Col>
                  </Row>
                </>
                ...
                <>
                  <Row className="mt-3">
                    ...
                    >
                      <h5 className="mb-2 fw-semibold">User Name</h5>
                      <p className="fw-normal">
                        {data?.order?.addresses?.[2]?.first_name +
                          " " +
                          data?.order?.addresses?.[2]?.last_name}
                      </p>
                    </Col>
                    <Col
                      xs={12}
                    ...
                    >
                      <h5 className="mb-2 fw-semibold">Address:</h5>
                      <p className="fw-normal">
                        {data?.order?.addresses?.[2]?.address}
                      </p>
                    </Col>
                    <Col
                      xs={12}
                    ...
                    >
                      <h5 className="mb-2 fw-semibold">Country:</h5>
                      <p className="fw-normal">
                        {data?.order?.addresses?.[2]?.country}
                      </p>
                    </Col>
                    <Col
                      xs={12}
                    ...
                    >
                      <h5 className="mb-2 fw-semibold">Zip Code:</h5>
                      <p className="fw-normal">
                        {data?.order?.addresses?.[2]?.zip_code}
                      </p>
                    </Col>
                  </Row>
                </>
